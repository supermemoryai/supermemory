...
import type { Metadata } from "../../apps/backend/src/types"
...
export const users = pgTable(
    "users",
    {
        ...
        lastApiKeyGeneratedAt: timestamp(
    ...
    (users) => ({
        ...
        usersNameIdx: index("users_name_idx").on(
            users.firstName,
            users.lastName,
        ),
...
export const spaceMembers = pgTable(
    ...
    (spaceMembers) => ({
        spaceMembersSpaceUserIdx: uniqueIndex(
            "space_members_space_user_idx",
        ).on(spaceMembers.spaceId, spaceMembers.userId),
    }),
)
