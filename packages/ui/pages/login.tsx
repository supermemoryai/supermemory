...
export function LoginPage({
  ...
  const handleSubmitToken = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    router.push(
      ...
      }/api/auth/magic-link/verify?token=${token}&callbackURL=${encodeURIComponent(
        callbackURL
      )}`
    );
  };
        ...
        <CarouselContent>
          <CarouselItem className="relative">
            <Image
              ...
              width={600}
            />
            <div className="absolute inset-0 flex flex-col justify-end p-8 lg:p-14 pr-10 lg:pr-16">
