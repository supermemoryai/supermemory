        ...
        <html lang="en">
            ...
            <body>
                <div className="gradient-dark">
                    <header className="bg-gray-900/50 dot-pattern">
                        ...
                        <div className="container mx-auto px-6 py-16 text-center">
                            ...
                            <p className="text-xl text-gray-300 mb-8">
                                Build powerful search and AI applications with
                                our flexible, production-ready API
                            </p>
                    ...
                    <section
                        id="features"
                        className="py-20 bg-gray-900/50 dot-pattern"
                    >
                            ...
                            <div className="grid md:grid-cols-3 gap-8">
                                <div className="p-6 border border-gray-600 rounded-lg bg-gray-900 hover:bg-gray-800 transition duration-300">
                                    ...
                                    <p className="text-gray-300">
                                        ...
                                        generation architecture for reliable and
                                ...
                                <div className="p-6 border border-gray-600 rounded-lg bg-gray-900 hover:bg-gray-800 transition duration-300">
                                    ...
                                    <p className="text-gray-300">
                                        Use any LLM of your choice or operate in
                                        search-only mode for maximum flexibility
                                        and control.
                                    </p>
                                </div>
                                <div className="p-6 border border-gray-600 rounded-lg bg-gray-900 hover:bg-gray-800 transition duration-300">
                                    ...
                                    <p className="text-gray-300">
                                        Comprehensive collection filtering and
                                        permission management for secure data
                                        access.
                                    </p>
                                </div>
                                <div className="p-6 border border-gray-600 rounded-lg bg-gray-900 hover:bg-gray-800 transition duration-300">
                                    ...
                                    <p className="text-gray-300">
                                        Magic link import and platform
                                        synchronization for effortless data
                                        integration.
                                    </p>
                                </div>
                                <div className="p-6 border border-gray-600 rounded-lg bg-gray-900 hover:bg-gray-800 transition duration-300">
                                    ...
                                    <p className="text-gray-300">
                                        ...
                                        in real-time with detailed metrics.
                                    </p>
                                </div>
                                <div className="p-6 border border-gray-600 rounded-lg bg-gray-900 hover:bg-gray-800 transition duration-300">
                                    <h3 className="text-xl font-semibold mb-4 text-white">
                                    ...
                                    <p className="text-gray-300">
                                        Simple API endpoints that integrate
                    ...
                    <footer className="bg-black/50 dot-pattern">
                        <div className="container mx-auto px-6">
                            <div className="grid md:grid-cols-4 gap-8">
                                <div>
                                    ...
                                    <p className="text-gray-400">
                                        Making memory management simple and
                                        efficient for developers worldwide.
                                    </p>
                                </div>
                                <div>
                                    <h4 className="text-lg font-semibold mb-4">
                            ...
                            <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                                <p>
                                    &copy; 2024 Supermemory API. All rights
                                    reserved.
                                </p>
                            </div>
                        </div>
