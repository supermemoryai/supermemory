            ...
            >
                ...
                <div className="flex flex-col gap-4 text-base font-geist max-w-md text-center font-light text-gray-200">
                    <p className="select-text">
                        We use Cloudflare's "bindings" architecture, meaning
                        encryption keys are never exposed - not even to our
                        developers. Your data remains encrypted and inaccessible
                        without your authorization.
                    </p>
                    <p className="select-text">
                        Our entire codebase is open source and available for
                        security review at{" "}
                        <a
                    ...
                    <p className="select-text">
                        Your data is encrypted at rest and in transit, and we
                        use industry-standard encryption. You maintain full
                        control over your data, including the right to export or
