        ...
        >
            ...
            >
                ...
                <p className="text-gray-300 text-center max-w-lg">
                    Choose one of our integrations to get started quickly. Your
                    data will be encrypted and securely imported.
                </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-2xl mt-4">
                    {Object.values(integrations).map((integration) => {
                        ...
                        const requiresExtension =
                            integration.requiresChromeExtension
                            ...
                            <motion.button
                                ...
                                onClick={() => {
                                    ...
                                    if (
                                        ...
                                        toast(
                                            "Please install the Chrome extension first",
                                            {
                                                action: {
                                                    label: "Install",
                                                    onClick: () => {
                                    ...
                                    if (integration.handleConnection) {
                                        integration.handleConnection(
                                            env,
                                            navigate,
                                        )
                                    } else if (integration.getAuthUrl) {
                                        window.location.href =
                                            integration.getAuthUrl(env)
                                    }
                                }}
