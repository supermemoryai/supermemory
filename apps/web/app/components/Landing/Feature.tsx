        ...
        <div className="flex flex-col gap-2 justify-center items-center">
            ...
            <div className="w-full mx-auto text-center">
                ...
                <p className="text-gray-600 max-w-3xl mx-auto">
                    Save the things you like, and over time, build the knowledge
                    base of your dreams.
                    <br />
                    Go down rabbit holes, make connections, search what's
                    important to you.
                </p>
            </div>
        </div>
