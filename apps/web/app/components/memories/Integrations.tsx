            ...
            <DialogContent className="sm:max-w-md">
                {integration.id === "xBookmarks" && !extensionPresent ? (
                    <div className="text-center">
                        ...
                        <DialogDescription>
                            Please install the SuperMemory extension to connect
                            with X
                        </DialogDescription>
                        <Button
                            variant="outline"
                    ...
                    <div className="text-center">
                        ...
                        <DialogDescription className="mt-4">
                            The import has started. It will keep going in the
                            background. You can close this modal and enjoy
                            supermemory! (You might need to reload to see the
                            changes!)
                        </DialogDescription>
                        <Button
                            variant="outline"
            ...
            eventSource.onmessage = (event) => {
                try {
                    ...
                    if (data.progress === 100) {
                        ...
                        if (toastId) {
                            toast.success(
                                "Successfully imported from Notion!",
                                {
                                    id: toastId,
                                },
                            )
                        ...
                        <>
                            ...
                            <div className="text-center">
                                ...
                                <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
                                    This may take a few minutes. You can close
                                    this modal and let it run in the background.
                                </p>
                            </div>
                        </>
                    )}
