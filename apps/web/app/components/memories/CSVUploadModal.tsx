            ...
            <DialogContent className="sm:max-w-md">
                {isUploading ? (
                        ...
                        {progress ? (
                            <>
                                ...
                                <DialogTitle className="mt-4">
                                    Processing URLs ({progress.processed}/
                                    {progress.total})
                                </DialogTitle>
                    ...
                    <div className="space-y-4">
                        ...
                        <DialogDescription>
                            Upload a CSV file containing URLs to add to your
                            memories. The URLs should be in the first column.
                        </DialogDescription>
