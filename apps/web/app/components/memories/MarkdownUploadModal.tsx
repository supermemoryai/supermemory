                    ...
                    if (line.startsWith("data: ")) {
                        try {
                            ...
                            if (
                                ...
                                toast.error(
                                    `Failed to import: ${data.title} - ${data.error}`,
                                )
                            }
            ...
            <DialogContent className="sm:max-w-md">
                {isUploading ? (
                        ...
                        {progress ? (
                            <>
                                ...
                                <DialogTitle className="mt-4">
                                    Processing Files ({progress.processed}/
                                    {progress.total})
                                </DialogTitle>
                    ...
                    <div className="space-y-4">
                        ...
                        <DialogDescription>
                            Upload markdown files from your Obsidian vault. You
                            can select multiple files or drop a folder.
                        </DialogDescription>
