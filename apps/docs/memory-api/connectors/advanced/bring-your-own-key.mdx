...
For example:
- Google Drive: `https://api.supermemory.ai/v3/connections/auth/callback/google-drive`
- GitHub: `https://api.supermemory.ai/v3/connections/auth/callback/github`
...
// Example: Configure GitHub custom OAuth credentials
const settings = await client.settings.update({
