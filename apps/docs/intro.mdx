...
- [Connectors and syncing](/concepts/connectors-syncing)
...
- [Evolve on top of existing context about the user](/concepts/memory-graph), **in real time**
...
Having the latest, evolving context about the user allows us to also create a [**User Profile**](/concepts/user-profile). This is a combination of static and dynamic facts about the user, that the agent should **always know**
...
Head to the [**How it works**](/concepts/how-it-works) guide to understand the underlying way of how supermemory represents and learns in data.
