...
description: "Integrate Google Drive, Notion, OneDrive, and GitHub to automatically sync documents into your knowledge base"
sidebarTitle: "Overview"
---

Connect external platforms to automatically sync documents into Supermemory. Supported connectors include Google Drive, Notion, OneDrive, and GitHub with real-time synchronization and intelligent content processing.
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub" icon="git-branch" href="/connectors/github">
    **Repositories, Issues, PRs**

    Real-time sync via webhooks. Syncs code documentation, issues, pull requests, and discussions.
  </Card>
</CardGroup>
