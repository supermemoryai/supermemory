...
- **OAuth Authentication** - Secure authentication via Supermemory's OAuth flow
...
The server uses OAuth authentication. Your MCP client will automatically discover the authorization server via `/.well-known/oauth-protected-resource` and prompt you to authenticate.
